...
/// <summary>Represents an invoice from the easyVerein API.</summary>
public class Invoice
{
    ...
    /// <summary>Gets or sets the receiver name. Maps to API field '<c>receiver</c>'.</summary>
    [JsonPropertyName(InvoiceFields.Receiver)] public string? Receiver { get; set; }

    /// <summary>Gets or sets the related address ID. Maps to API field '<c>relatedAddress</c>'.</summary>
    [JsonPropertyName(InvoiceFields.RelatedAddress)] public long? RelatedAddress { get; set; }

    /// <summary>Gets or sets the list of related booking IDs. Maps to API field '<c>relatedBookings</c>'.</summary>
    [JsonPropertyName(InvoiceFields.RelatedBookings)] public List<long>? RelatedBookings { get; set; }

    /// <summary>Gets or sets the ID of the user who paid. Maps to API field '<c>payedFromUser</c>'.</summary>
    [JsonPropertyName(InvoiceFields.PayedFromUser)] public long? PayedFromUser { get; set; }

    /// <summary>Gets or sets the ID of the admin who approved. Maps to API field '<c>approvedFromAdmin</c>'.</summary>
    [JsonPropertyName(InvoiceFields.ApprovedFromAdmin)] public long? ApprovedFromAdmin { get; set; }

    /// <summary>Gets or sets the ID of the canceled invoice. Maps to API field '<c>canceledInvoice</c>'.</summary>
    [JsonPropertyName(InvoiceFields.CanceledInvoice)] public long? CanceledInvoice { get; set; }

    /// <summary>Gets or sets the bank account ID. Maps to API field '<c>bankAccount</c>'.</summary>
    ...
    /// <summary>Gets or sets the recurring invoices interval. Maps to API field '<c>recurringInvoicesInterval</c>'.</summary>
    ...
    /// <summary>Gets or sets the related offer ID. Maps to API field '<c>relatedOffer</c>'.</summary>
